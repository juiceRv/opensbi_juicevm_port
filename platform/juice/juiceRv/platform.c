...
{
	sbi_printf("file: %s func: %s line:%d\n", __FILE__,__FUNCTION__,__LINE__);
	return 0;
}
...
{
	/* Example if the generic UART8250 driver is used */
	// *(char *)(pdev_uart0_write_addr) = 'p';
	// *(char *)(pdev_uart0_write_addr) = 'l';
	// *(char *)(pdev_uart0_write_addr) = 'a';
	// *(char *)(pdev_uart0_write_addr) = 't';
	// *(char *)(pdev_uart0_write_addr) = 'f';
	// *(char *)(pdev_uart0_write_addr) = 'o';
	// *(char *)(pdev_uart0_write_addr) = 'r';
	// *(char *)(pdev_uart0_write_addr) = 'm';
	// *(char *)(pdev_uart0_write_addr) = '_';
	// *(char *)(pdev_uart0_write_addr) = 'c';
	// *(char *)(pdev_uart0_write_addr) = 'o';
	// *(char *)(pdev_uart0_write_addr) = 'n';
	// *(char *)(pdev_uart0_write_addr) = 's';
	// *(char *)(pdev_uart0_write_addr) = 'o';
	// *(char *)(pdev_uart0_write_addr) = 'l';
	// *(char *)(pdev_uart0_write_addr) = 'e';
	// *(char *)(pdev_uart0_write_addr) = '_';
	// *(char *)(pdev_uart0_write_addr) = 'p';
	// *(char *)(pdev_uart0_write_addr) = 'u';
	// *(char *)(pdev_uart0_write_addr) = 't';
	// *(char *)(pdev_uart0_write_addr) = 'c';
	// *(char *)(pdev_uart0_write_addr) = '\n';

	*(char *)(pdev_uart0_write_addr) = ch;
}
...
static int platform_timer_init(bool cold_boot)
{
	// return 0;
	int ret;
	sbi_printf("file: %s func: %s line:%d cold_boot:%d\n", __FILE__,__FUNCTION__,__LINE__,cold_boot);
	/* Example if the generic CLINT driver is used */
	if (cold_boot) {
		clint.time_val = (u64 *)(0x92c00003);
		clint.time_cmp = (u64 *)(0x92c00007);
